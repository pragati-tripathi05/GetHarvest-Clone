    ...
    <>
      <Container bgColor="#1d1e1c" color="white" padding="5%" maxW="100%">
        <Flex textAlign="left" gap="5rem">
          ...
          <Box marginLeft="5%">
            <Flex direction="column" fontSize="22px" fontWeight="medium">
              <Box>Community</Box>
              <br />
              <Box>Customer stories</Box>
              <Box>Resources</Box>
              <Box>Webinars</Box>
              <Box>Help & Support</Box>
              <Box>Integrate with Harvest</Box>
              <Box>Time Well Spent</Box>
              <Box>Time in This Time</Box>
            </Flex>
          </Box>
          <Box marginLeft="5%">
            <Flex direction="column" fontSize="22px" fontWeight="medium">
        ...
        >
          ...
          schedule your team across projects.
        </Button>
        <br />
        <br />
        <br />
        <Flex justifyContent="space-between">
          <Box fontSize="22px" fontWeight="medium" color="darkgray">
            © 2006-2022 Harvest
          </Box>
          <Box>
            <Flex gap="3rem">
