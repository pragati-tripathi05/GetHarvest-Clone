...
import { Divider, Flex, Button, Box } from "@chakra-ui/react";
...
const NavbarMain = () => {
  ...
  return (
    <Flex justifyContent="space-around" bg="#fff8f1" padding="2%">
      <Box>
        <NavLink to="/">
          <svg
      ...
      <Flex gap="3rem" w="50%" marginLeft="-5%" _hover={{ color: "#fa5d00" }}>
        <NavLink
      ...
      <Flex gap="1rem">
        <Box fontSize="22px" _hover={{ color: "#fa5d00" }}>
